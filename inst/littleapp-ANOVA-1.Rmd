...
output$stats <- renderText({
  ...
  third <- sprintf("F = R<sup>2</sup>/moddf ÷ (1 - R<sup>2</sup>)/resdf<br> &nbsp; &nbsp;  = (%g/%d) ÷ (%g/%d) ➼ %g<br>",
...
<table><tr><td class="control">`r SAMPN` `r A` `r B` `r SHOWSD` `r STATS` `r SEED` </td><td class="plot">`r P`</td></tr></table>
